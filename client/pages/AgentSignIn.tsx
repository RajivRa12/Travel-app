...
export default function AgentSignIn() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Map email to agent id for demo
      let agentId = "1";
      if (formData.email === "kenji@tokyotours.jp") agentId = "2";
      else if (formData.email === "maria@riotravel.com") agentId = "3";
      else if (formData.email === "ahmed@egyptadventures.com") agentId = "4";
      else if (formData.email === "emma@londonheritage.co.uk") agentId = "5";
      else if (formData.email === "raj@mumbaiexpert.com") agentId = "6";
      else if (formData.email === "hello@keraladreams.com") agentId = "7";
      // Set agent user in localStorage
      localStorage.setItem("user", JSON.stringify({ id: agentId, role: "agent", email: formData.email }));
      setIsLoading(false);
